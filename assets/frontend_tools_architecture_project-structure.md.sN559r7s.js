import{_ as n}from"./app.CFpAW6CY.js";import{c as a,o as p,a7 as l}from"./chunks/vue.Bn_qOzU9.js";import"./chunks/vendor.j62-d68X.js";const g=JSON.parse('{"title":"企业级前端项目架构设计","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/tools/architecture/project-structure.md","filePath":"frontend/tools/architecture/project-structure.md","lastUpdated":1755180371000}'),i={name:"frontend/tools/architecture/project-structure.md"};function e(t,s,c,r,o,h){return p(),a("div",null,s[0]||(s[0]=[l(`<h1 id="企业级前端项目架构设计" tabindex="-1">企业级前端项目架构设计 <a class="header-anchor" href="#企业级前端项目架构设计" aria-label="Permalink to &quot;企业级前端项目架构设计&quot;">​</a></h1><p>基于现代前端技术栈的企业级项目架构设计方案，涵盖目录结构、技术选型、构建配置等核心要素。</p><h2 id="🏗️-项目架构概览" tabindex="-1">🏗️ 项目架构概览 <a class="header-anchor" href="#🏗️-项目架构概览" aria-label="Permalink to &quot;🏗️ 项目架构概览&quot;">​</a></h2><h3 id="核心设计原则" tabindex="-1">核心设计原则 <a class="header-anchor" href="#核心设计原则" aria-label="Permalink to &quot;核心设计原则&quot;">​</a></h3><ul><li><strong>模块化设计</strong>：API管理层、组件分层、状态管理分离</li><li><strong>渐进式升级</strong>：支持新旧代码并存，平滑技术迁移</li><li><strong>开发体验</strong>：热重载、自动导入、代码提示、构建分析</li><li><strong>生产就绪</strong>：完善的构建优化、错误监控、性能分析</li></ul><h2 id="📁-标准目录结构" tabindex="-1">📁 标准目录结构 <a class="header-anchor" href="#📁-标准目录结构" aria-label="Permalink to &quot;📁 标准目录结构&quot;">​</a></h2><h3 id="完整项目结构" tabindex="-1">完整项目结构 <a class="header-anchor" href="#完整项目结构" aria-label="Permalink to &quot;完整项目结构&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>project-root/</span></span>
